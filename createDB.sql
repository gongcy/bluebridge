...
CREATE TABLE solution_blue (
  ...
  `ans` varchar(256) NOT NULL DEFAULT '' COMMENT '提交答案',
  ...
  `submit_time` datetime NOT NULL DEFAULT '1970-01-01' COMMENT '提交时间',
...
CREATE TABLE `contest_blue` (
  ...
  `title` varchar(256) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '比赛名称',
  `start_time` datetime NOT NULL DEFAULT '1970-01-01' COMMENT '比赛开始时间',
  `end_time` datetime NOT NULL DEFAULT '1970-01-01' COMMENT '比赛结束时间',
  `defunct` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT '废弃标志',
  `description` varchar(256) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '比赛描述',
...
CREATE TABLE `contest_blue_problem` (
  ...
  `title` varchar(256) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '',
...
CREATE TABLE `problem_fillblank` (
  ...
  `title` varchar(256) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '题目名称',
  `description` text COLLATE utf8_unicode_ci NOT NULL COMMENT '题目描述',
  `solution` varchar(1024) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '题目正确答案',
  `hint` varchar(2048) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '题目提示',
  `defunct` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT '废弃标志',
  PRIMARY KEY (`problem_id`)
